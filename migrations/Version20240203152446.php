 ...
 */
final class Version20240203152446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exchange_rate (id INT NOT NULL, currency VARCHAR(5) NOT NULL, bank VARCHAR(15) NOT NULL, buy INT NOT NULL, sell INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE exchange_rate_history (id INT NOT NULL, exchange_rate_id INT NOT NULL, buy INT NOT NULL, sell INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
